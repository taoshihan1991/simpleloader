...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Shihan Tao">
    <title>陶士涵的菜地</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4 class="text-white">关于我</h4>
          <p class="text-muted">2014年毕业于聊城大学，2013-2014年在聊城网络公司主要负责CMS网站开发，2014-2016年在济南网络科技公司主要负责电商网站开发，2016至今在北京新浪总部主要负责新浪邮箱开发。</p>
        </div>
        <div class="col-sm-4 offset-md-1 py-4">
          <h4 class="text-white">联系我</h4>
          <ul class="list-unstyled">
            <li><a href="#" class="text-white">邮箱：630892807@qq.com</a></li>
            <li><a href="#" class="text-white">微信：haotsh</a></li>
          </ul>
        </div>
      </div>
    </div>
